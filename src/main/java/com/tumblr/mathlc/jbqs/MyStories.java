...
import com.tumblr.mathlc.jbqs.steps.UsuarioValidoSteps;
...
public class MyStories extends JUnitStories {
    ...
    public static class StepsModule extends AbstractModule {
        ...
        protected void configure() {
        	...
        	bind(UsuarioValidoSteps.class).in(Scopes.SINGLETON);
        	bind(UsuarioSemEMailSteps.class).in(Scopes.SINGLETON);
        	bind(UsuarioComEMailInvalidoSteps.class).in(Scopes.SINGLETON);
        	bind(ConsultaUsuariosSteps.class).in(Scopes.SINGLETON);
        }
